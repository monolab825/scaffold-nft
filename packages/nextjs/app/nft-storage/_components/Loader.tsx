...
// import { ContextActions, UploadProgress } from "@w3ui/react";
import { ArrowPathIcon } from "@heroicons/react/20/solid";

// function StatusLoader({ progressStatus }: { progressStatus: ContextActions }): ReactNode {
...
//         <div className="bg-white w100" style={{ height: `${percentComplete}%` }}></div>
//       </div>
//     );
//   } else {
