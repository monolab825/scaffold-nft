...
export function AuthenticationForm(): ReactNode {
  ...
  return (
    <div className="authenticator">
      ...
      <Authenticator.Form className="text-zinc-950 bg-grad rounded-xl shadow-md px-10 pb-8">
        <div>
          <label
          ...
          <Authenticator.EmailInput
            className="text-white py-2 px-2 rounded block mb-4 border border-gray-800 w-80 shadow-md"
    ...
    <div className="authenticator">
      <div className="bg-grad rounded-xl shadow-md px-10 pt-8 pb-8">
        ...
        <p className="pt-2 pb-4">
          Click the link in the email we sent to <span className="font-semibold tracking-wide">{email}</span> to
